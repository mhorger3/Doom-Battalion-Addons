...
/*	class B_SDV_01_F;
	...
	class 101st_Miner_Droid: StaticMGWeapon
	{
		...
		forceInGarage=1;
		crew = "B_UAV_AI";
		model = "101st_Aux_Mod\Addons\Vehicles\Miner\Miner.p3d";
		hiddenSelections[] = {"head", "chest", "guns", "legs"};
		hiddenSelectionsTextures[] = {"101st_Aux_Mod\Addons\Vehicles\Miner\Head_CO.paa","101st_Aux_Mod\Addons\Vehicles\Miner\Chest_CO.paa", "101st_Aux_Mod\Addons\Vehicles\Miner\Guns_CO.paa", "101st_Aux_Mod\Addons\Vehicles\Miner\Legs_CO.paa"};
		scope=2;
		forceInGarage=1;
		scopeCurator=2;
		class Armory
