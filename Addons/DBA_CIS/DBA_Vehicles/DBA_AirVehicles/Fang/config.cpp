...
class CfgVehicles
{
	...
	class 101st_Mando_base: Plane_Fighter_03_dynamicLoadout_base_F
	{
		...
		scope=1;
		scopecurator=1;
		model="\101st_Aux_Mod\Addons\DBA_CIS\DBA_Vehicles\DBA_AirVehicles\Fang\Fang_Fighter.p3d";
		...
		{
			"\101st_Aux_Mod\Addons\DBA_CIS\DBA_Vehicles\DBA_AirVehicles\Fang\Grey_CO.paa"
		};
		insideSoundCoef=0.2;
	...
	class 101st_Mando_Ship: 101st_Mando_base
	{
		...
		hiddenselectionstextures[]=
		{
			"\101st_Aux_Mod\Addons\DBA_CIS\DBA_Vehicles\DBA_AirVehicles\Fang\Blue_CO.paa"
		};
		weapons[]=
		{
			"CMFlareLauncher"
	...
	class 101st_Mando_Ship_Red: 101st_Mando_base
	{
		...
		hiddenselectionstextures[]=
		{
			"\101st_Aux_Mod\Addons\DBA_CIS\DBA_Vehicles\DBA_AirVehicles\Fang\Red_CO.paa"
		};
		gunBeg[]=
		{
			"Usti hlavne1",
