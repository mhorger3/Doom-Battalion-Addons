		...
		soundEngineOnInt[] = {"3as\3as_saber\Sounds\tx130start.wss", 2, 1}; //0.630957
		soundEngineOnExt[] = {"3as\3as_saber\Sounds\tx130start.wss", 4, 1, 200}; //0.794328
		soundEngineOffInt[] = {"3as\3as_saber\Sounds\tx130stop.wss", 2, 1}; //0.630957
		soundEngineOffExt[] = {"3as\3as_saber\Sounds\tx130stop.wss", 4, 1, 200}; //0.794328
