...
class CfgVehicles
{
	...
	class DBA_CIS_IG_Base : O_Soldier_F
	{
		...
		side = 0;
		faction = "O_DBA_CIS_F";
		editorPreview = "DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_BX_Base_F.jpg";
	...
	class O_DBA_CIS_IG88_F : DBA_CIS_IG_Base
	{
		...
		editorPreview = "DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_IG101_MagnaGuard_F.jpg";
