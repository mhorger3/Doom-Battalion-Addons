...
class CfgVehicles
{
	...
	class DBA_B1_Backpack_GeonosisCamo: DBA_B1_Backpack
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Geo_B1_Backpack_CO.paa"
		};
	};
	...
	class DBA_B1_Backpack_JungleCamo : DBA_B1_Backpack
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Jungle_B1_Backpack_CO.paa"
		};
	};
	class DBA_B1_Backpack_WinterCamo : DBA_B1_Backpack
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Winter_B1_Backpack_CO.paa"
		};
	};
	...
	class DBA_B1_Antenna_GeonosisCamo : DBA_B1_Antenna
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Geo_B1_Antenna_CO.paa"
		};
	};
	...
	class DBA_B1_Antenna_JungleCamo : DBA_B1_Antenna
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Jungle_B1_Antenna_CO.paa"
		};
	};
	class DBA_B1_Antenna_WinterCamo : DBA_B1_Antenna
	{
		...
		hiddenSelectionsTextures[] =
		{
			"DBA_CIS\Addons\DBA_Armour\DBA_B1Battledroid\data\Winter_B1_Antenna_CO.paa"
		};
	};
