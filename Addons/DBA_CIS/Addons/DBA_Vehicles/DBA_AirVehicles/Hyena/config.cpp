...
class CfgVehicles
{
	...
	class 101st_Hyena_base: RD501_z95_blue
	{
		...
		scope=1;
		scopecurator=1;
		model="DBA_CIS\Addons\DBA_Vehicles\DBA_AirVehicles\Hyena\Hyena_Bomber.p3d";
		...
		{
			"DBA_CIS\Addons\DBA_Vehicles\DBA_AirVehicles\Hyena\Body_CO.paa", "DBA_CIS\Addons\DBA_Vehicles\DBA_AirVehicles\Hyena\Wings_CO.paa" 
		};
		hiddenSelectionsMaterials[] = {"DBA_CIS\Addons\DBA_Vehicles\DBA_AirVehicles\Hyena\Body.rvmat","DBA_CIS\Addons\DBA_Vehicles\DBA_AirVehicles\Hyena\Wings.rvmat"};
		insideSoundCoef=0.2;
