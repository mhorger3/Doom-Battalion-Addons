...
class CfgVehicles
{
	...
	class O_DBA_CIS_MTT_F: 3as_MTT
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_MTT_F.jpg";
	...
	class O_DBA_CIS_Squad_Assault_Craft_F: 3as_SAC_Trade
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Squad_Assault_Craft_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Ammo_F: 442_argon_ammo_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Ammo_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Device_F: 442_argon_device_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Device_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Fuel_F: 442_argon_fuel_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Fuel_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Medical_F: 442_argon_medical_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Medical_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Repair_F: 442_argon_repair_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Repair_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Transport_F: 442_argon_transport_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Transport_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
	class O_DBA_CIS_Argon_Transport_Covered_F: 442_argon_covered_cis
	{
		...
		side=0;
		faction="O_DBA_CIS_F";
		editorPreview="DBA_CIS\Addons\EditorPreviews_F\Data\O_DBA_CIS_Argon_Transport_Covered_F.jpg";
		crew="O_DBA_CIS_B1_Crew_Droid_F";
	};
};