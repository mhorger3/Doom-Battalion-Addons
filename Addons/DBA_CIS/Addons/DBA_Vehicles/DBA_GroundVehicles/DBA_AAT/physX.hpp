...
fuelCapacity		= 50;
brakeIdleSpeed		= 1.78; //1.78	/// speed in m/s below which braking is applied
latency 			= 0.1;
tankTurnForce		= 700000; /// Random magic number, expected to be something like 11 x mass of vehicle
...
class complexGearbox {
	GearboxRatios[]    = {"R2",-3.9,"N",0,"D1",4.0,"D2",3.2,"D3",2.6,"D4",2.0,"D5",1.5,"D6",1.125,"D7",0.85};
