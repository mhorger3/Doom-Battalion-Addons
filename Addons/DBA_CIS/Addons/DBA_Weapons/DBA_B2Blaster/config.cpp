...
class CfgWeapons
{
	...
	class DBA_B2_Weapon : Rifle_Long_Base_F
	{
		...
		scope = 2;
		scopeArsenal = 2;
		model = "DBA_CIS\Addons\DBA_Weapons\DBA_B2Blaster\b2gun.p3d";
		...
		simulation = "Weapon";
		handAnim[] = { "OFP2_ManSkeleton","DBA_CIS\Addons\DBA_Weapons\DBA_B2Blaster\b2.rtm" };
		...
		class Secondary : Rifle_Long_Base_F {
			...
			class Single : Mode_SemiAuto
			{
				...
				{
					weaponSoundEffect = "DefaultRifle";
					begin1[] = { "DBA_CIS\Addons\DBA_Weapons\DBA_B2Blaster\Wrist.wss",1,1,1800 };
					soundBegin[] = { "begin1",1 };
					closure1[] = { "A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_01",0.5,1,10 };
					closure2[] = { "A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_02",0.5,1,10 };
					soundClosure[] = { "closure1",0.5,"closure2",0.5 };
		...
		class Single : Mode_SemiAuto
		{
			...
			{
				weaponSoundEffect = "DefaultRifle";
				begin1[] = { "DBA_CIS\Addons\DBA_Weapons\DBA_B2Blaster\b2.ogg",1,1,1800 };
				soundBegin[] = { "begin1",1 };
				closure1[] = { "A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_01",0.5,1,10 };
				closure2[] = { "A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_02",0.5,1,10 };
				soundClosure[] = { "closure1",0.5,"closure2",0.5 };
