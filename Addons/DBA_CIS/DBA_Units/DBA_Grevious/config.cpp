...
class CfgWeapons
{
	...
	class UniformItem;
	class JLTS_Grevious: U_I_CombatUniform
	{
		JLTS_isDroid=1;
		...
		scope=2;
		displayName="101st Grevious Uniform";
		picture="\MRC\JLTS\characters\DroidArmor\data\ui\b1_uniform_ui_ca.paa";
		model="\101st_Aux_Mod\Addons\DBA_CIS\DBA_Grevious\Grevious.p3d";
		hiddenSelections[] = {"head", "body", "arms"};
		hiddenSelectionsTextures[] = {"", "", ""};
		class ItemInfo: UniformItem
		{
			uniformModel="-";
			uniformClass="101st_Grevious";
...
class O_soldier_base_F;
	...
	class 101st_Grevious: O_Soldier_F
	{
		author="MrClock + Dutch";
		scope=2;
		displayName="101st General Grevious";
		editorPreview="\MRC\JLTS\characters\DroidArmor\data\ui\editorPreviews\JLTS_Droid_B1_E5.jpg";
		genericNames="101st_CIS_Grevious";
		faction="O_DBA_CIS_F";
