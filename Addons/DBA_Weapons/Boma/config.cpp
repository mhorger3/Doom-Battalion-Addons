...
class CfgWeapons
{
	...
	class DBA_DP23: Rifle_Long_Base_F
	{
		ACE_overheating_allowSwapBarrel = 1;
		ACE_Overheating_Dispersion = 0;
		ACE_Overheating_JamChance = 0;
		...
		JLTS_shieldedWeapon = "DBA_DP23_shield";

		picture = "\MRC\JLTS\weapons\DP23\data\ui\DP23_ui_ca.paa";
		model = "\MRC\JLTS\weapons\DP23\DP23.p3d";
		hiddenSelections[] = {"camo1"};
		hiddenSelectionsTextures[] = {"\MRC\JLTS\weapons\DP23\data\DP23_co.paa"};
		...
		displayName = "[101st] DP-23 Shotgun (Experimental)";
		descriptionShort = "DP-23 Shotgun";
		baseWeapon = "DBA_DP23";
	...
	class DBA_DP23_shield: DBA_DP23
	{
		displayName = "$STR_JLTS_names_DP23Shield";
		baseWeapon = "DBA_DP23_shield";
		scope = 1;
		JLTS_isShielded = 1;
		JLTS_baseWeapon = "DBA_DP23";
