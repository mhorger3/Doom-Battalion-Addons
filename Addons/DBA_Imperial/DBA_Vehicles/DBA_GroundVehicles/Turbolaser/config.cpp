...
class CfgVehicles
{
	...
	class DBA_TurboLaserCannon_Base : StaticMGWeapon
	{
		...
		model = "DBA_Imperial\Addons\DBA_Imperial\DBA_Vehicles\DBA_GroundVehicles\Turbolaser\DBA_Turbolaser.p3d";
		hiddenSelections[] =
		{
			"Camo",
			"Camo1"
		...
		{
			"DBA_Imperial\Addons\DBA_Imperial\DBA_Vehicles\DBA_GroundVehicles\Turbolaser\Data\Turbo_Laser_Tower_Body_CO.paa",
			"DBA_Imperial\Addons\DBA_Imperial\DBA_Vehicles\DBA_GroundVehicles\Turbolaser\Data\Turbo_Laser_Gun_CO.paa"
		};
