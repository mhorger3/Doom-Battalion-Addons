...
class CfgVehicles
{
	...
	class DBA_TIEFighter_VTOL_Base_F : VTOL_Base_F
	{
		...
		model = "DBA_Imperial\Addons\DBA_Vehicles\DBA_Airvehicles\DBA_TIEFighter\DBA_TIEFighter.p3d";
	...
	class DBA_TIEFighter_VTOL_Base : DBA_TIEFighter_VTOL_Base_F
	{
		author = "$STR_A3_Bohemia_Interactive";
	...
	class DBA_TIEFighter_VTOL_Dynamic_Base_F : DBA_TIEFighter_VTOL_Base
	{
		author = "$STR_A3_Bohemia_Interactive";
	...
	class DBA_TIEFighter_VTOL_Dynamic_F : DBA_TIEFighter_VTOL_Dynamic_Base_F
	{
		author = "Vulgar";
