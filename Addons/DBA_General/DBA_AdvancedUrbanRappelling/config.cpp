...
class CfgFunctions 
{
	class SA
	{
		...
		{
			file = "DBA_Core\Addons\DBA_AdvancedUrbanRappelling\functions";
...
class CfgSounds
{
	class AUR_Rappel_Loop
	{
		...
		sound[] = {"DBA_Core\Addons\DBA_AdvancedUrbanRappelling\sounds\AUR_Rappel_Loop.ogg", db+5, 1};
		titles[] = {0,""};
	};
	class AUR_Rappel_Start
	{
		name = "AUR_Rappel_Start";
		sound[] = {"DBA_Core\Addons\DBA_AdvancedUrbanRappelling\sounds\AUR_Rappel_Start.ogg", db+10, 1};
		titles[] = {0,""};
	};
	class AUR_Rappel_End
	{
		name = "AUR_Rappel_End";
		sound[] = {"DBA_Core\Addons\DBA_AdvancedUrbanRappelling\sounds\AUR_Rappel_End.ogg", db+10, 1};
		titles[] = {0,""};
	};
};
...
class Extended_PreInit_EventHandlers
{
	...
	{
        init = "call compile preprocessFileLineNumbers 'DBA_Core\Addons\DBA_AdvancedUrbanRappelling\XEH_preInit.sqf'";
    };
};
