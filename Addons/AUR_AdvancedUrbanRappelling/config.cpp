...
class CfgSounds
{
	class AUR_Rappel_Loop
	{
		...
		sound[] = {"101st_Aux_Mod\Addons\AUR_AdvancedUrbanRappelling\sounds\AUR_Rappel_Loop.ogg", db+5, 1};
		titles[] = {0,""};
	};
	class AUR_Rappel_Start
	{
		name = "AUR_Rappel_Start";
		sound[] = {"101st_Aux_Mod\Addons\AUR_AdvancedUrbanRappelling\sounds\AUR_Rappel_Start.ogg", db+10, 1};
		titles[] = {0,""};
	};
	class AUR_Rappel_End
	{
		name = "AUR_Rappel_End";
		sound[] = {"101st_Aux_Mod\Addons\AUR_AdvancedUrbanRappelling\sounds\AUR_Rappel_End.ogg", db+10, 1};
		titles[] = {0,""};
	};
};
...
class Extended_PreInit_EventHandlers
{
	...
	{
        init = "call compile preprocessFileLineNumbers '101st_Aux_Mod\Addons\AUR_AdvancedUrbanRappelling\XEH_preInit.sqf'";
    };
};
