class B_DBA_P2CloneBeconLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
...
class B_DBA_P2CloneCourageLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
...
class B_DBA_P2CloneLambertLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
...
class B_DBA_P2CloneProdigyLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
...
class B_DBA_P2CloneQuillLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
...
class B_DBA_P2CloneSeeforLegacy_F : B_DBA_P2Clone_Base
{
	scope = 2;
	scopeCurator = 2;
