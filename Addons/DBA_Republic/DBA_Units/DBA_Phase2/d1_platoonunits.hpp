...
//Dagger
class Dagger_Recruit_DBA : B_DBA_P2Clone_Base
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Recruit";
	uniformClass = "101st_212th_Dagger";
	editorSubcategory = "O_DBA_Republic_Airborne";
...
class Dagger_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Trooper";
	uniformClass = "Dagger_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
...
class Dagger_CP_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Corporal";
	uniformClass = "Dagger_CP_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
...
class Dagger_CS_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Sergeant";
	uniformClass = "Dagger_CS_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
...
class Dagger_Medic_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Medic";
	uniformClass = "Dagger_Medic_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
...
class Dagger_RTO_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 RTO";
	uniformClass = "Dagger_RTO_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
...
class Dagger_Traitor_DBA : Dagger_Recruit_DBA
{
	displayName = "[DBA] Phase 2 Clone: Dagger 1 Traitor";
	uniformClass = "Dagger_Traitor_DBA_Uniform";
	hiddenSelectionsTextures[]=
	{
