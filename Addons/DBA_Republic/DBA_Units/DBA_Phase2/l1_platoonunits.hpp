...
//Longbow
class Longbow_DBA : B_DBA_P2Clone_Base
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Base";
	uniformClass = "Longbow_DBA_Uniform";
	editorSubcategory = "O_DBA_Republic_Recon";
...
class Longbow_Arid_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Arid";
	uniformClass = "Longbow_Arid_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
...
class Longbow_Recruit_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Recruit";
	uniformClass = "Longbow_Recruit_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
...
class Longbow_Tropic_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Tropic";
	uniformClass = "Longbow_Tropic_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
...
class Longbow_Night_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Night";
	uniformClass = "Longbow_Night_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
...
class Longbow_Urban_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Urban";
	uniformClass = "Longbow_Urban_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
...
class Longbow_Winter_DBA : Longbow_DBA
{
	displayName = "[DBA] Phase 2 Clone: Longbow 1 Winter";
	uniformClass = "Longbow_Winter_DBA_Uniform";
	hiddenSelectionsTextures[] =
	{
