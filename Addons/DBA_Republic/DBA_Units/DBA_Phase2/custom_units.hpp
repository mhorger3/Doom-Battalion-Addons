...
class B_DBA_P2CloneDutch_F : B_DBA_P2Clone_Base
{
...
class B_DBA_P2CloneBlind_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneKel_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneJerec_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Jerec";
...
class B_DBA_P2CloneVin_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneGrae_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneKai_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Kai";
...
class B_DBA_P2CloneBlackwater_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneSeatie_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneAJ_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneSpark_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Spark";
...
class B_DBA_P2CloneVulgar_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneBlood_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneRepublican_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2ClonePunisher_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneKodiak_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneFodder_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneOaksy_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Oaksy";
...
class B_DBA_P2CloneMisfit_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneFalcon_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneServo_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneBacon_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Bacon";
...
class B_DBA_P2CloneHambino_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneHeretic_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneDog_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneNoble_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneCourage_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Courage";
...
{
	displayName = "[DBA] Phase 2 Clone: Lambert";
...
class B_DBA_P2CloneProdigy_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Prodigy";
...
class B_DBA_P2CloneQuill_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Quill";
...
class B_DBA_P2CloneSeefor_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Seefor";
...
class B_DBA_P2CloneDolittle_F : B_DBA_P2CloneDutch_F
{
...
class B_DBA_P2CloneRadar_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Radar";
	uniformClass = "DBA_P2CloneRadarUniform";
	hiddenSelectionsTextures[] =
	{
...
class B_DBA_P2CloneHark_F : B_DBA_P2CloneDutch_F
{
	displayName = "[DBA] Phase 2 Clone: Hark";
	uniformClass = "DBA_P2CloneHarkUniform";
	hiddenSelectionsTextures[] =
	{
