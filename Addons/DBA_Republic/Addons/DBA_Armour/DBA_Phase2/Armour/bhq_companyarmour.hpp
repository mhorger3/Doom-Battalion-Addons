class DBA_P2CloneBHQUniform : DBA_P2cloneRecruitUniform
{
	...
	{
		"DBA_Republic\Addons\DBA_Armour\DBA_Phase2\Armour\data\Custom\BroadswordHQ\HQ_Armor_upper_CO.paa",
...
class DBA_P2CloneBHQMUniform : DBA_P2cloneRecruitUniform
{
	...
	hiddenSelectionsTextures[] =
	{
		"DBA_Republic\Addons\DBA_Armour\DBA_Phase2\Armour\data\Custom\BroadswordHQ\HQM_Armor_upper_CO.paa",
...
class DBA_P2CloneBHQRUniform : DBA_P2cloneRecruitUniform
{
	...
	hiddenSelectionsTextures[] =
	{
		"DBA_Republic\Addons\DBA_Armour\DBA_Phase2\Armour\data\Custom\BroadswordHQ\HQR_Armor_upper_CO.paa",
