...
class CfgAmmo{
	...
	class DBA_UT2_TD : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",1.5,1,90};
		hiddenselections[] = {"camo1"};
		hiddenSelectionsMaterials[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermal.rvmat"};
		hiddenselectionstextures[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\ThermalDetonator_CO.paa"};
		model = "DBA_Republic\Addons\DBA_Explosives\thermal.p3d";
		hit = 20;
		indirectHit = 24;
	...
	class DBA_UT3_TD : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",1.75,1.15,90};
		hiddenselections[] = {"camo1"};
		hiddenSelectionsMaterials[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermal.rvmat"};
		hiddenselectionstextures[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\ThermalDetonator_CO.paa"};
		model = "DBA_Republic\Addons\DBA_Explosives\thermal.p3d";
	...
	class DBA_UT5_TD : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",2.5,1.55,90};
		hiddenselections[] = {"camo1"};
		hiddenSelectionsMaterials[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermal.rvmat"};
		hiddenselectionstextures[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\ThermalDetonator_CO.paa"};
		model = "DBA_Republic\Addons\DBA_Explosives\thermal.p3d";
	...
	class DBA_UTD7C_TD : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",1.75,0.55,90};
		model = "\A3\Weapons_F\explosives\c4_charge_small";
		hit = 10;
		indirectHit = 275;
	...
	class DBA_UTF3_Flash : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",6.75,1.75,200};
		model = "\z\ace\addons\grenades\models\ACE_m84_thrown.p3d";
	...
	class DBA_SN3_Det : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",3.75,0.35,100};
		model = "DBA_Republic\Addons\DBA_Explosives\imploder.p3d";
		hiddenselections[] = {"camo1"};
		hiddenSelectionsMaterials[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalImploder\imploder.rvmat"};
		hiddenselectionstextures[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalImploder\ThermalImploder_CO.paa"};
		hit = 10;
		indirectHit = 40;
	...
	class DBA_SNF15_Flash : GrenadeHand{
		...
		soundFly[] = {"DBA_Republic\Addons\DBA_Explosives\data\ThermalDet\thermalDetFly.ogg",4.75,2.35,150};
		model = "\z\ace\addons\grenades\models\ACE_m84_thrown.p3d";
		effectsSmoke = "ACE_M84FlashbangEffect";
		simulation = "shotSmoke";
		hit = 15;
