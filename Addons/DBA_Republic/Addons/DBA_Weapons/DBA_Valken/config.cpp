...
class CfgWeapons
{
	...
	class DBA_Valken_Base_F : Rifle_Long_Base_F
	{
		...
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_Valken\valken.p3d";
		scope = 0;
		magazines[] =
		{
			"DBA_Valken_Mag"
		...
		hiddenSelectionsTextures[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Valken\data\Valken_CO.paa" };
		hiddenSelectionsMaterials[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Valken\data\Valken.rvmat" };
		handAnim[] =
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Valken\anims\ValkenHandAnim.rtm"
		};
		cursor = "srifle";
		...
		class Single : Mode_SemiAuto
		{
			...
			class StandardSound
			{
				...
				begin1[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Valken\valken.ogg",1,1,900 };
	...
	class DBA_Valken_F : DBA_Valken_Base_F
	{
		...
		picture = "DBA_Republic\Addons\DBA_Effects\icons\Valken_CA.paa";
		UiPicture = "DBA_Republic\Addons\DBA_Effects\icons\Valken_CA.paa";
