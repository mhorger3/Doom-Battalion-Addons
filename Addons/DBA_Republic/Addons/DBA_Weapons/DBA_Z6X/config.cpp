...
class DBA_Z6X_P : Launcher_Base_F
	{
		...
		picture = "DBA_Republic\Addons\DBA_Effects\icons\Z6-X_CA.paa";
		...
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6X\anims\Z6XHandAnim.rtm"
		};
		hiddenSelections[] =
		{
			"Camo1",
		...
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\data\Z6X_Handle_CO.paa",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\data\Z6X_Body_CO.paa",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\data\Z6X_Mag_CO.paa",
		};
		hiddenSelectionsMaterials[] =
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\Data\Z6X_Handle.RVMAT",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\Data\Z6X_Body.RVMAT",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Z6\Data\Z6X_Mag.RVMAT",
		};
...
class CfgMagazines{
	class CA_Magazine;
	class DBA_25mm_PL15SN_x500_mag : CA_Magazine{
		scope=2;
