...
class CfgWeapons
{
	...
	class DBA_SandoLauncher_F : Launcher_Base_F
	{
		...
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_Sando\SandoFinal.p3d";
		hiddenSelections[] =
		{
			"camo1",
			"camo2"
		...
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Sando\Data\Front_CO.paa",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Sando\Data\Back_gun_CO.paa"
		};
		hiddenSelectionsMaterials[] =
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Sando\Data\SandoFront.rvmat",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Sando\Data\SandoBack.rvmat"
		};
		picture = "DBA_Republic\Addons\DBA_Effects\icons\Sando_CA.paa";
		UiPicture = "DBA_Republic\Addons\DBA_Effects\icons\Sando_CA.paa";
		handAnim[] =
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Sando\anims\SandoHandAnim.rtm"
		};
		hiddenSelections[] =
		{
			"Camo_1",
