...
class CfgWeapons
{
	...
	class DBA_Billo_F : Rifle_Long_Base_F
	{
		...
		author = "Dutch";
		scope = 2;
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_Billo\billo.p3d";
		...
		hiddenSelectionsTextures[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Billo\billo_co.paa" };
		hiddenSelections[] =
		{
			"camo1"
		};
		...
		handAnim[] = { "OFP2_ManSkeleton","DBA_Republic\Addons\DBA_Weapons\DBA_Billo\anims\BilloHandAnim.rtm" };
		class Single : Mode_SemiAuto
		{
			...
			class StandardSound : BaseSoundModeType
			{
				...
				begin1[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Billo\Billow_Shot.ogg",2,1,2700 };
