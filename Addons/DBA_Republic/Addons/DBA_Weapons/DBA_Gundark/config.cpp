...
class CfgWeapons
{
	...
	class DBA_Gundark_Base_F : Rifle_Long_Base_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Gundark\anims\GundarkHandAnim.rtm"
		};
		opticsPPEffects[] = {};
		opticsFlare = 1;
		hiddenSelections[] =
		...
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Gundark\data\Gundark_CO.paa",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Gundark\data\Gundark_Scope_CO.paa"
		};
		hiddenSelectionsMaterials[] =
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Gundark\data\Gundark.rvmat",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Gundark\data\GundarkScope.rvmat"
		};
	...
	class DBA_Gundark_F : DBA_Gundark_Base_F
	{
		...
		picture = "DBA_Republic\Addons\DBA_Effects\icons\Walrus_CA.paa";
		UiPicture = "DBA_Republic\Addons\DBA_Effects\icons\Walrus_CA.paa";
		class Library
		{
			libTextDesc = ":wave:";
		};
