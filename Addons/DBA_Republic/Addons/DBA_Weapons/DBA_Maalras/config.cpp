...
class cfgWeapons {
	...
	class DBA_MaalrasSMG_Base_F : Rifle_Base_F
	{
		...
		hiddenSelectionsTextures[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Maalras\data\Maalras_CO.paa" };
		hiddenSelectionsMaterials[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Maalras\Rifle.rvmat" };
		modelOptics = "-";
		optics = 1;
		...
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Maalras\anims\MaalrasHandAnim.rtm"
		};
		...
		class Single : Mode_SemiAuto
		{
			...
			{
				weaponSoundEffect = "";
				begin1[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Maalras\SMG.ogg",1,1,1800 };
				soundBegin[] = { "begin1",1 };
			};
		};
