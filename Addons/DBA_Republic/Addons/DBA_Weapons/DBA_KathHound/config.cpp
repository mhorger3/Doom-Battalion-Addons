...
class CfgWeapons
{
	...
	class DBA_KathHound: Rifle_Long_Base_F
	{
		...
		author = "Dutch & Trip";
		scope = 2;
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_KathHound\KathHound.p3d";
		...
		hiddenSelectionsTextures[] = {"DBA_Republic\Addons\DBA_Weapons\DBA_KathHound\data\Kath_Hound_CO.paa"};
		drySound[] = {"MRC\JLTS\weapons\Core\sounds\weapon_dry.wss",5,1,10};
		soundBullet[] = {};
		modes[] = {"Single","FullAuto","close","short","medium"};
		recoil = "recoil_mk20";
		simulation = "Weapon";
		handAnim[] = {"OFP2_ManSkeleton","DBA_Republic\Addons\DBA_Weapons\DBA_KathHound\anims\KathHoundHandAnim.rtm"};
		...
		class Single: Mode_SemiAuto
		{
			...
			class StandardSound: BaseSoundModeType
			{
				...
				begin1[] = {"DBA_Republic\Addons\DBA_Weapons\DBA_KathHound\AR.ogg",1,1,1800};
				soundBegin[] = {"begin1",1};
			};
