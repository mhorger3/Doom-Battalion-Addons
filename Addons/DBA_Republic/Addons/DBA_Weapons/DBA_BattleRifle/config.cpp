...
class CfgWeapons
{
	...
	class DBA_Battlerifle_Base_F : Rifle_Long_Base_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_BattleRifle\anims\BattlerifleHandAnim.rtm"
		};
		...
		class Single : Mode_SemiAuto
		{
			...
			class StandardSound
			{
				...
				begin1[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Battlerifle\Data\DC15Shot.ogg",1,1,1800 };
	...
	class DBA_BattleRifle_F : DBA_Battlerifle_Base_F
	{
		...
		scope = 2;
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_BattleRifle\BattleRifle.p3d";
		dexterity = 1.6799999;
		displayName = "DBA Battlerifle";
		...
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_BattleRifle\Data\MBR_CO.paa",
		};
		hiddenSelectionsMaterials[] =
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_BattleRifle\Data\MBR.rvmat",
		};
	};
};
class cfgVehicles
