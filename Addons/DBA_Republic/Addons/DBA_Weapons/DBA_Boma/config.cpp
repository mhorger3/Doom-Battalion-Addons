...
class CfgWeapons
{
	...
	class DBA_Boma_Shotgun_F : Rifle_Long_Base_F
	{
		...
		author = "Trip";
		scope = 2;
		model = "DBA_Republic\Addons\DBA_Weapons\DBA_Boma\Data\Boma_Shotgun.p3d";
		picture = "DBA_Republic\Addons\DBA_Effects\icons\Boma_CA.paa";
		handAnim[] = { "OFP2_ManSkeleton","DBA_Republic\Addons\DBA_Weapons\DBA_Boma\anims\BomaHandAnim.rtm" };
