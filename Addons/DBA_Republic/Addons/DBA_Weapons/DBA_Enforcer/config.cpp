...
class CfgWeapons
{
	...
	class DBA_Enforcer_Base_F : Rifle_Short_Base_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"DBA_Republic\Addons\DBA_Weapons\DBA_Enforcer\anims\EnforcerHandAnim.rtm"
		};
		hiddenSelections[] =
		{
			"camo1"
		...
		{
			"DBA_Republic\Addons\DBA_Weapons\DBA_Enforcer\data\Enforcer_CO.paa",
		};
		...
		class Single : Mode_SemiAuto
		{
			...
			{
				weaponSoundEffect = "";
				begin1[] = { "DBA_Republic\Addons\DBA_Weapons\DBA_Enforcer\SMG.ogg",1,1,1800 };
				soundBegin[] = { "begin1",1 };
			};
			reloadTime = 0.05;
