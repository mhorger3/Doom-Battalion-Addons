...
class CfgVehicles {
	...
	class 101st_Flag_Green : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\FlagGreenOnGreen.paa""";
		};
	};
	class 101st_Flag_Republic : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\Republic.paa""";
		};
	};
	class 101st_Flag_Seatie : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\Seatie.paa""";
		};
	};
	...
	class 101st_Flag_Black : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\FlagGreenOnBlack.paa""";
		};
	};
	...
	class 101st_Flag_White : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\FlagGreenOnWhite.paa""";
		};
	};
	class 101st_Flag_Jerec : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\FlagJerec.paa""";
		};
	};
	...
	class 101st_Flag_Logo : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\Logo.paa""";
		};
	};
	...
	class 101st_Flag_Formal : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\101st.paa""";
		};
	};
	...
	class 101st_Flag_Senate : ACE_Flag_Black
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) setFlagTexture ""DBA_Republic\Addons\DBA_Flags\Senate.paa""";
		};
	};
};