...
class cfgVehicles
{
	...
	class 101st_Nuclass: 3as_nuclass_f
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\exterior_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\wings_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\interior_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\cockpit_doors_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\NU-Exterior.rvmat",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\NU-Wings.rvmat",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\NU-Interior.rvmat",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\Nu\NU-Cockpit.rvmat"
		};
		class ViewPilot
		{
			initAngleX = 0;
	...
	class 101st_ARC_Modified : 3as_arc_170_blue //changed from 3as_arc_170_green due to broken model
	{
		...
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\ARC-170\101st_Guns_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\ARC-170\101st_Main_Frame_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\ARC-170\101st_Wings_Engines_CO.paa",
		};
		weapons[]=
		{
			"Laserdesignator_pilotCamera",
	...
	class DBA_LAAT_PYLON_TESTBED : B_Heli_Attack_01_base_F{
		...
		hiddenselectionstextures[] =
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\LAAT\DBA_Hammer_Hull_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\LAAT\DBA_Hammer_Wings_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\LAAT\DBA_Hammer_Weapons_CO.paa",
			"3AS\3as_Laat\LAATI\data\Weapon_Details_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_AirVehicles\LAAT\DBA_Hammer_Interior_CO.paa"
        };
