...
class CfgVehicles
{
	...
	class DBA_Utility_Vehicle : C_Offroad_02_unarmed_F
	{
		...
		class TextureSources
		{
			class Command_Mobility_Vehicle
			{
				...
				textures[] = 
				{
				"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\CMV\Command_Mobility_Vehicle.paa",
				"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\CMV\Command_Mobility_Vehicle.paa",
	...
	class DBA_Command_Mobility_Vehicle: C_Offroad_02_unarmed_F
	{
		...
		class TextureSources
		{
			class Bommand_Mobility_Vehicle
			{
				...
				textures[] = 
				{
				"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\CMV\BMV_CO.paa",
				"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\CMV\BMV_CO.paa",
				"\A3\Soft_F_Exp\Offroad_02\Data\offroad_02_int_black_co.paa",
				"\A3\Soft_F_Exp\Offroad_02\Data\offroad_02_int_black_co.paa"
				};
	...
	class DBA_TX130_Standard: 3as_saber_m1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_hull_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_weapons_co.paa"
		};
		class TransportItems
		{
	...
	class DBA_TX130_GMG: 3as_saber_m1G
	{
		...
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_hull_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_weaponsgmg_co.paa"
		};
		class TransportItems
		{
			class _transport_ToolKit
	...
	class DBA_TX130_Recon: 3as_saber_m1Recon
	{
		...
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_hull_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Saber\saber_weapons_scout_co.paa"
		};
		class TransportItems
		{
			class _transport_ToolKit
	...
	class 101st_Warden_Tank: B_APC_Tracked_01_rcws_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warden\overseer_ext1_cream_green_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warden\overseer_ext2_cream_green_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warden\overseer_turret_cream_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warden\overseer_ext3_cream_green_co.paa",
	...
	class DBA_Warrior_Testbed: I_APC_tracked_03_cannon_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warrior\warrior_ext_01_101_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warrior\warrior_ext_02_101_co.paa",
	...
	class DBA_Winter_Warrior: I_APC_tracked_03_cannon_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warrior\warrior_ext_01_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Warrior\warrior_ext_02_co.paa",
			"A3\Armor_F\Data\camonet_AAF_Digi_Green_CO.paa",
			"A3\armor_f\data\cage_aaf_co.paa"
		};
		icon="\A3\Armor_F_EPB\APC_Tracked_03\Data\UI\map_APC_Tracked_03_CA.paa";
	...
	class DBA_LSV: O_T_LSV_02_unarmed_black_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\LSV_CO.paa",
	...
	class DBA_Fennek: I_MRAP_03_hmg_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\Fennek_Red_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\Fennek_Red_Turret_CO.paa"
		};
		scope=2;
		scopeCurator=2;
		side=1;
		...
		class TextureSources
		{
			class DBA_Fennek_Green
			{
				...
				textures[] = 
				{
					"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\Fennek_Green_co.paa",
					"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\Fennek_Green_Turret_CO.paa"
				};
				factions[] = {"B_DBA_Republic_F"};
			};
	...
	class DBA_Fennek_Medic: I_MRAP_03_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\fennek_Red_Medic_CO.paa"
		};
		scope=2;
		scopeCurator=2;
		side=1;
		...
		class TextureSources
		{
			class DBA_Fennek_Green
			{
				...
				textures[] = 
				{
					"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Fennek\Fennek_Green_Medic_co.paa"
				};
				factions[] = {"B_DBA_Republic_F"};
			};
			class DBA_Fennek_Red
	...
	class DBA_Leopard_Testbed: I_MBT_03_cannon_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\101stMBT_ext01_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\101stMBT_ext02_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\101st_mbt_03_rcws_co.paa",
			"A3\Armor_F\Data\camonet_AAF_Digi_Green_CO.paa"
		};
		faction="B_DBA_Republic_F";
	...
	class DBA_Merkava_Testbed: B_MBT_01_TUSK_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\MBT_01_body_101st_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\MBT_01_tow_101st_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\MBT_01_addons_101st_CO.paa",
			"a3\Armor_F\Data\camonet_NATO_Desert_CO.paa"
		};
		faction="B_DBA_Republic_F";
	...
	class DBA_Armata_Testbed: O_T_MBT_04_command_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\MBT_04_exterior_1_101st_Gray_CO.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\MBT\MBT_04_exterior_2_101st_Gray_CO.paa",
	...
	class DBA_Marid: O_APC_Wheeled_02_rcws_v2_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\marid_co.paa",
			"",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\maridturret_co.paa",
			"",
			""
		};
		forceInGarage=1;
	...
	class DBA_Skorpion: I_LT_01_cannon_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\skorpionmain_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\skorpionturret_co.paa",
			"",
			""
		};
		class Turrets: Turrets
	...
	class DBA_Viper: O_APC_Tracked_02_cannon_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\vipermain_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\viper2nd_co.paa",
			"DBA_Republic\Addons\DBA_Vehicles\DBA_GroundVehicles\Testing\viperturret_co.paa",
			"",
			""
		};
		class Turrets: Turrets
