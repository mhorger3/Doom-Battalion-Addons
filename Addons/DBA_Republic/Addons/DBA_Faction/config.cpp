...
{
	class B_DBA_Republic_F
	{
		displayName = "DBA Republic";
	};
};

class CfgEditorSubcategories
{
	class O_DBA_Republic_Spec_Ops
	{
		displayName = "DBA Republic Special Operations";
	};
	class O_DBA_Republic_Clones
	{
	...
	class O_DBA_Republic_APCs
	{
		displayName = "APCs";
	};
	class O_DBA_Republic_Cars
	{
		displayName = "Cars";
	};
	class O_DBA_Republic_AAs
	{
		displayName = "AAs";
	};
	class O_DBA_Republic_Planes
	{
		displayName = "Planes";
	};
};