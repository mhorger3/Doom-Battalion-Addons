...
class CfgWeapons
{
	...
	class DBA_DC15x: JLTS_DC15x
	{
		...
		hiddenSelectionsTextures[] = {"101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_DC15x\data\DC15X_CO.paa","101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_DC15x\data\DC15X_Scope_CO.paa"};
		maxZeroing = 1200;
		opticsZoomMin = 0.01;
		opticsZoomMax = 0.042;
	...
	class DBA_Desert_DC15x: DBA_Forest_DC15x
	{
		...
		hiddenSelections[] = {"camo","camo1","camo2"};
		hiddenSelectionsTextures[] = {"101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_DC15x\data\DC15X_CO.paa","101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_DC15x\data\DC15X_Scope_CO.paa","101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_DC15x\data\DC15X_Netting_Desert_CO.paa"};
	};
