...
class CfgWeapons
{
	...
	class DBA_Zillo_F : Rifle_Long_Base_F
	{
		...
		author = "Dutch, Frisk";
		scope = 2;
		model = "101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_Zillo\zillo.p3d";
		...
		hiddenSelectionsTextures[] = { "101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_Zillo\data\atRifle_CO.paa" };
		hiddenSelections[] =
		{
			"camo1"
		};
