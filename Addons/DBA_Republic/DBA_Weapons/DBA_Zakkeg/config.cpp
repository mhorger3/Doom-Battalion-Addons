...
class CfgWeapons
{
	...
	class DBA_ZakkegMG_F: Rifle_Long_Base_F
	{
		...
		simulation = "Weapon";
		handAnim[] = {"OFP2_ManSkeleton","101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_Zakkeg\anims\ZakkegHandAnimC.rtm"};
		...
		class manual: Mode_FullAuto
		{
			...
			{
				weaponSoundEffect = "DefaultRifle";
				begin1[] = {"101st_Aux_Mod\Addons\DBA_Republic\DBA_Weapons\DBA_Zakkeg\Zakkeg.ogg",1,1,1800};
				soundBegin[] = {"begin1",1};
				closure1[] = {"A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_01",0.5,1,10};
				closure2[] = {"A3\Sounds_F\arsenal\weapons\Rifles\MX\Closure_Mx_02",0.5,1,10};
				soundClosure[] = {"closure1",0.5,"closure2",0.5};
