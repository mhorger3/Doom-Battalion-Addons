...
class CfgFunctions
{
    class DBA_Vehicles
	{
		class functions
		{
			file = "101st_Aux_Mod\Addons\DBA_VehicleFunctions\functions";
...
class Extended_PreInit_EventHandlers
{
	...
	{
        init = "call compile preprocessFileLineNumbers '101st_Aux_Mod\Addons\DBA_VehicleFunctions\XEH_preInit.sqf'";
    };
};
