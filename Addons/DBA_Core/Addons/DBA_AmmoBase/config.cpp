...
class CfgAmmo
{
	...
	class DBA_ammo_base : BulletBase
	{
		...
		model = "DBA_Core\Addons\DBA_AmmoBase\BlasterBoltBlue.p3d";
		...
		bulletFly1[] =
		{
			"DBA_Core\Addons\DBA_AmmoBase\DBA_BlasterFire.wss",
			1.58,
			1,
			30
		};
	...
	class DBA_AntiTank_base :DBA_ammo_base //AT Rifle Ammo
	{
		...
		tracerScale = 3;
		model = "DBA_Core\Addons\DBA_AmmoBase\BlasterBoltGreen.p3d";
