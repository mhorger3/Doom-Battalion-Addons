...
class CfgMagazineWells
{
	...
	{
		DBA_GL_flare_magwell[]=
		{
			"DBA_40mm_white_x3_mag",
			"DBA_40mm_CIR_x3_mag",
			"DBA_40mm_Green_x3_mag",
			"DBA_40mm_Red_x3_mag",
			"DBA_40mm_Yellow_x3_mag",
			"DBA_40mm_Blue_x3_mag",
			"DBA_40mm_Cyan_x3_mag",
			"DBA_40mm_Purple_x3_mag"
		};
		DBA_GL_AP_magwell[]=
		{
			"DBA_AT_GL_x2_mag",
			"DBA_UGL_AP_x2_mag",
			"101st_flash_GL_x3_mag"
		};
		DBA_GL_HE_magwell[]=
		{
			"DBA_HE_GL_x3_mag",
	...
	{
		DBA_1rnd_GL_flare_magwell[]=
		{
			"DBA_40mm_white_x1_mag",
			"DBA_40mm_CIR_x1_mag",
			"DBA_40mm_Green_x1_mag",
			"DBA_40mm_Red_x1_mag",
			"DBA_40mm_Yellow_x1_mag",
			"DBA_40mm_Blue_x1_mag",
			"DBA_40mm_Cyan_x1_mag",
			"DBA_40mm_Purple_x1_mag"
		};
		DBA_1rnd_smoke_magwell[]=
		{
...
class CfgMagazines
{
	...
	class DBA_65_Mag_x45_Blue: DBA_65_Mag_Base
	{
		scope=2;
		displayname="6.5mw Magazine(45rnd Blue)";
		ammo="DBA_65_blue";
		picture="\MRC\JLTS\weapons\DC15A\data\ui\DC15A_mag_ui_ca.paa";
		model="\MRC\JLTS\weapons\DC15A\DC15A_mag.p3d";
		mass=15;
	...
	class DBA_127x33_x7_Yellow: DBA_Mag_Base
	{
		scope=2;
	...
	class DBA_12gaScatter_x5_Blue: DBA_Mag_Base
	{
		scope=2;
	...
	class DBA_12gaSlug_x5_Blue: DBA_Mag_Base
	{
		scope=2;
	...
	class DBA_P7_Magazine: DBA_Mag_Base
	{
		scope=2;
		displayname="P7 Magazine (7rnd Blue)";
		ammo="P7_Base_Ammo";
		picture="\MRC\JLTS\weapons\DC15x\data\ui\DC15X_mag_ui_ca.paa";
		model="\MRC\JLTS\weapons\DC15x\DC15x_mag.p3d";
		mass=55;
...
class CfgAmmo
{
	...
	class DBA_556_base: DBA_ammo_base
	{
		hit=9;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_65_base: DBA_ammo_base
	{
		hit=10;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_LegoGun_ammo: DBA_ammo_base
	{
		hit=15000;
		indirecthit=15000;
		indirecthitrange=3;
	...
	class DBA_AMMO_ORBITAL: DBA_ammo_base
	{
		hit=1;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_762_base: DBA_ammo_base
	{
		hit=11.6;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_338_base: DBA_ammo_base
	{
		hit=16;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_Vulken: DBA_ammo_base
	{
		hit=19;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_408_base: DBA_ammo_base
	{
		hit=24;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_127x99_base: DBA_ammo_base
	{
		hit=30;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_127x99_SLAP_base: DBA_ammo_base
	{
		hit=50;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_AntiTank_base: DBA_ammo_base
	{
		hit=550;
		indirecthit=30;
	...
	class DBA_EMP_base: DBA_ammo_base
	{
		hit=1;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_9x21_base: DBA_ammo_base
	{
		hit=5;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_45acp_base: DBA_ammo_base
	{
		hit=5;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_127x33_base: DBA_ammo_base
	{
		hit=7.5;
		indirecthit=0;
		indirecthitrange=0;
	...
	class DBA_12gaSlug_Base: DBA_ammo_base
	{
		hit=42;
		indirectHit=0;
		indirectHitRange=0;
	...
	class DBA_12gaPellets_Base: DBA_shotgun_base
	{
		hit=4;
		indirectHit=2;
		indirectHitRange=0.40000001;
	...
	class P7_Base_Ammo: DBA_ammo_base
	{
		hit=23;
		indirecthit=0;
		indirecthitrange=0;
	...
	class 101st_imploder_ammo: Grenade
	{
		...
		soundFly[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\thermalimploderFly.ogg",
			1.5,
			1,
			90
		};
		...
		soundHit3[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\imploderExplode3.ogg",
			2,
			1,
			2000
		};
		...
		{
			"\101st_Aux_Mod\Addons\_ammo\imploder.rvmat"
		};
	};
	class 101st_throwable_c_type_ammo: Grenade
	{
		...
		hiddenSelectionsMaterials[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\ctype.rvmat"
		};
		ExplosionEffects="MineNondirectionalExplosion";
		CraterEffects="MineNondirectionalCrater";
		soundFly[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\ctypeFly.ogg",
			1,
			1,
			90
		};
	...
	class 101st_thermaldet_ammo: Grenade
	{
		...
		soundFly[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\thermalDetFly.ogg",
			1.5,
			1,
			90
		};
		...
		hiddenSelectionsMaterials[]=
		{
			"\101st_Aux_Mod\Addons\_ammo\thermal.rvmat"
		};
		fuseDistance=0;
	};
