...
class CfgWeapons
{
	...
	class JLTS_Tuskan: U_I_CombatUniform
	{
		...
		model="\101st_Aux_Mod\Addons\DBA_Independent\DBA_Tuskan\Body\Tuskan.p3d";
		hiddenSelections[] = {"head", "body"};
		hiddenSelectionsTextures[] = {"101st_Aux_Mod\Addons\DBA_Independent\DBA_Tuskan\tuskanraider_head_co.paa", "101st_Aux_Mod\Addons\DBA_Independent\DBA_Tuskan\Body\tuskanraider_body_co.paa"};
