...
class CfgWeapons
{
	...
	class DBA_TuskanTrooperUniform : Uniform_Base
	{
		...
		model = "DBA_Independent\Addons\DBA_Armour\DBA_Tuskan\Armour\data\Base\Tuskan.p3d";
		...
		hiddenSelectionsMaterials[] =
		{
			...
			"DBA_Independent\Addons\DBA_Armour\DBA_Tuskan\Armour\data\Base\DBA_Trooper_Legs.RVMAT"
		};
