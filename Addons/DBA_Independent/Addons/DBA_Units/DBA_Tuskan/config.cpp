...
class CfgVehicles {
	...
	class I_DBA_Tuskan_Trooper : I_DBA_Tuskan_Base
	{
		scope = 2;
		scopeCurator = 2;
		...
		uniformClass = "DBA_TuskanTrooperUniform";
	};
};
